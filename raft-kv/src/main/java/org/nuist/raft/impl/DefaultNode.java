...
import org.nuist.raft.common.PeerSet;
import org.nuist.raft.current.RaftThreadPool;
...
import org.nuist.raft.util.LongConvert;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import org.nuist.raft.Consensus;
import org.nuist.raft.LifeCycle;
import org.nuist.raft.LogModule;
import org.nuist.raft.Node;
...
import org.nuist.raft.entity.ReplicationFailModel;
...
public class DefaultNode<T> implements Node<T>, LifeCycle, ClusterMembershipChanges {
    ...
    public void init() throws Throwable {
        ...
        synchronized (this) {
            ...
            RaftThreadPool.scheduleAtFixedRate(electionTask, 16000, 15000);
    ...
    @Override
    public AentryResult handlerAppendEntries(AentryParam param) throws Exception{
     ...
     */
    @Override
    public synchronized ClientKVAck handlerClientRequest(ClientKVReq request) throws Exception{
