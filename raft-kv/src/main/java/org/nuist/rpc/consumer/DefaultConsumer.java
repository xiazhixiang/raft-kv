...
import org.nuist.rpc.common.utils.JUnsafe;
import org.nuist.rpc.common.utils.NettyChannelGroup;
...
public abstract class DefaultConsumer extends AbstractDefaultConsumer {
    ...
    public SubscribeManager subscribeService(final String service) {
        ...
        SubscribeManager manager = new SubscribeManager() {
            ...
            @Override
            public void start() {
                subscribeService(service, new NotifyListener() {
    ...
    @Override
    public void subscribeService(String subcribeServices, NotifyListener listener) {
