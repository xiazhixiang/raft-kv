...
import org.nuist.rpc.registry.model.RegistryPersistRecord;
import org.nuist.rpc.registry.model.RegistryPersistRecord.PersistProviderInfo;
...
import org.nuist.rpc.common.transport.body.MetricsCustomBody;
...
import org.nuist.rpc.common.utils.PersistUtils;
...
import static org.nuist.rpc.common.rpc.ManagerServiceRequestType.*;
...
public class RegistryProviderManager implements RegistryProviderServer {
	...
	// 某个服务
	private final ConcurrentMap<String, ConcurrentMap<RegisterMeta.Address, RegisterMeta>> globalRegisterInfoMap = new ConcurrentHashMap<String, ConcurrentMap<RegisterMeta.Address, RegisterMeta>>();
	// 指定节点都注册了哪些服务
	...
	public RemotingTransporter handleManager(RemotingTransporter request, Channel channel) throws RemotingSendRequestException, RemotingTimeoutException,
		...
		ManagerServiceCustomBody managerServiceCustomBody = SerializerHolder.serializerImpl().readObject(request.bytes(), ManagerServiceCustomBody.class);
	...
	private RemotingTransporter handleDegradeService(RemotingTransporter request, Channel channel) throws RemotingSendRequestException,
		...
		ManagerServiceCustomBody body = SerializerHolder.serializerImpl().readObject(request.bytes(), ManagerServiceCustomBody.class);
